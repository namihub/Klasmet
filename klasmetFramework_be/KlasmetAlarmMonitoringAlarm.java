...
public final class KlasmetAlarmMonitoringAlarm {
    ...
    private String xId;
    private String actionPresenter;
    private String actionMethod;

    public KlasmetAlarmMonitoringAlarm(String alarmId, String occuranceTime, String ackTime, String clearanceTime, String connectorName, String description, String severity, String parentAlarmId, boolean hasAction, String category,String xId,String actionPresenter,String actionMethod) {
        if (description == null) {
            this.description = "";
        } else {
        ...
        if (ackTime == null) {
            this.ackTime = "2000-01-01 00:00:00";
        } else {
            this.ackTime = ackTime;
        }
        if (clearanceTime == null) {
            this.clearanceTime = "2000-01-01 00:00:00";
        } else {
            this.clearanceTime = clearanceTime;
        }
        if (occuranceTime == null) {
            this.occuranceTime = "2000-01-01 00:00:00";
        } else {
    ...
    /**
     * @return the actionPresenter
     */
    public String getActionPresenter() {
        return actionPresenter;
    }

    /**
     * @param actionPresenter the actionPresenter to set
     */
    public void setActionPresenter(String actionPresenter) {
        this.actionPresenter = actionPresenter;
    }
